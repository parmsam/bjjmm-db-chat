...
source: "https://shiny.posit.co/py/docs/genai-chatbots.html"
language: "en"
...
![Screenshot of a conversation with the Chat component.](https://shiny.posit.co/py/images/chat-quick-start.png)
...
Startup messages are a great place to introduce the chatbot with a brief description of what it can do and, optionally, some [input suggestions](#suggest-input) to help the user get started quickly. Messages can also contain arbitrary Shiny UI [components](https://shiny.posit.co/py/components/index.html), so you could even include something like a [tooltip](https://shiny.posit.co/py/components/display-messages/tooltips/index.html) to provide additional details on demand.
...
![Screenshot of a chatbot with a welcome message.](https://shiny.posit.co/py/images/chat-hello.png)
...
When a Shiny app reloads, the app returns to it’s original state, unless the URL includes [bookmarked](https://shiny.posit.co/py/api/core/Session.html) state.[^1] Automatically updating the URL to include a bookmark of the chat state is a great way to help users return to their work if they accidentally refresh the page or unexpectedly lose their connection.
...
![Screenshot of a chatbot filling the page.](https://shiny.posit.co/py/images/chat-fill.png)

Screenshot of a chatbot filling the page.

### Card layout

Another useful UI pattern is to embed the chat component inside a `ui.card()`. If nothing else, this will help visually separate the chat from the rest of the app. It also provides a natural place to provide a header (with perhaps a [tooltip](https://shiny.posit.co/py/components/display-messages/tooltips/index.html) with more info about your chatbot). [Cards](https://shiny.posit.co/py/layouts/panels-cards/index.html#content-divided-by-cards) also come with other handy features like `full_screen=True` to make the chat full-screen when embedded inside a larger app.
...
![Screenshot of a chatbot embedded in a card with a header and tooltip.](https://shiny.posit.co/py/images/chat-card-tooltip.png)
...
![Screenshot of a chatbot with a custom theme and dark mode toggle.](https://shiny.posit.co/py/images/chat-themed.png)
...
![Screenshot of a chatbot with a custom (slack) icon.](https://shiny.posit.co/py/images/chat-hello-slack.png)
...
![Screenshot of a chatbot with a custom (shiny) image icon.](https://shiny.posit.co/py/images/chat-hello-shiny.png)
...
![Screenshot of an app using input controls to populate a user prompt](https://shiny.posit.co/py/images/genai-update-input.png)
...
Messages can contain Shiny UI elements like [inputs](https://shiny.posit.co/py/components/#inputs), [outputs](https://shiny.posit.co/py/components/#outputs), etc. This allows you to collect user input, display rich interactive output (e.g., [Jupyter Widgets](https://shiny.posit.co/py/docs/jupyter-widgets.html)), or provide additional context (e.g. [tooltips](https://shiny.posit.co/py/components/display-messages/tooltips/index.html)) from within the chat.
...
![Screenshot of a download button included in a chat message](https://shiny.posit.co/py/images/genai-interactive-messages.png)
...
TipInteractive tool displays

Probably the most interesting way in which interactive messages can be used is from a custom [tool call](https://shiny.posit.co/py/docs/genai-tools.html) display. For example, you could have a tool that displays a [Data Grid](https://shiny.posit.co/py/components/outputs/data-grid/index.html) or [Jupyter Widget](https://shiny.posit.co/py/docs/jupyter-widgets.html) (e.g., a [plotly](https://shiny.posit.co/py/components/outputs/plot-plotly/index.html) graph).
...
![Screenshot of a chatbot with an error message.](https://shiny.posit.co/py/images/chat-error.png)

Screenshot of a chatbot with an error message.

TipCustom error messages
...
When deploying AI chatbots to production, [OpenTelemetry tracing](https://shiny.posit.co/py/docs/opentelemetry.html) provides valuable insights:

- Track latency and token usage for LLM API calls
- Monitor error rates and identify failing prompts
- Understand user interaction patterns
- Debug issues without accessing production logs

Many observability platforms like [Logfire](https://shiny.posit.co/py/docs/opentelemetry.html#quick-setup-with-logfire) can automatically instrument AI libraries (OpenAI, Anthropic, etc.) to show API calls nested within your Shiny traces.
