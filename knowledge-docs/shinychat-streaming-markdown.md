...
source: "https://shiny.posit.co/py/docs/genai-stream.html"
language: "en"
description: "Build interactive web applications easily with the power of Python’s data and scientific stack."
word_count: 2336
---

In this article, you’ll learn how to stream markdown/HTML content into your app via `MarkdownStream()`. This component is general purpose, but it’s particularly useful in a generative AI setting where displaying markdown strings *as it’s being generated* is a common requirement.
...
![Screenshot of the streaming quick start app after a response has been generated.](https://shiny.posit.co/py/images/genai-stream-quick-start.png)
...
![Screenshot of a starting content message.](https://shiny.posit.co/py/images/genai-stream-starting-content.png)
...
![Screenshot of a stream within a card layout.](https://shiny.posit.co/py/images/genai-stream-card-layout.png)

Screenshot of a stream within a card layout.

TipMulti-card layout

If you want multiple cards in an app, it’s useful to know about Shiny’s [grid layout options](https://shiny.posit.co/py/layouts/arrange/index.html#).
...
![Screenshot of a chatbot with an error message.](https://shiny.posit.co/py/images/genai-stream-errors.png)
